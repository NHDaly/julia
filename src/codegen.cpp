        ...
        jl_codegen_params_t &params)
{
    ...
    JL_TRY {
        ...
        if (dump_emitted_mi_name_stream != NULL) {
            ...
            // The quotes break CSV parsing if there are any internal quotes in the Type
            // name (e.g.in Symbol("...")). The \t delineator should be enough.
            // (And there can't be any tabs in it because the tabs are printed as "\t")
